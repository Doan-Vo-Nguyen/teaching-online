...
class StudentClassesService {
    private readonly studentClassesRepository: IStudentClassesRepository = new StudentClassesRepository();
    ...
    public async getStudentClassByUserIdAndClassId(student_id: number, class_id: number) {
        return await this.studentClassesRepository.findByUserIdAndClassId(student_id, class_id);
    }

    public async enrollClass(student_id: number, class_id: number) {
        return await this.studentClassesRepository.enrollClass(student_id, class_id);
    }
