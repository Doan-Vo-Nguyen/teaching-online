...
export interface IExamSubmissionRepository extends IBaseRepository<ExamSubmission> {
    ...
    createExamSubmissionByStudentAndClass(exam_id: number, student_id: number, class_id: number, exam_content_id: number, examSubmission: ExamSubmission): Promise<ExamSubmission>
